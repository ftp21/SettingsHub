...
class MorpheusProvider(api.SettingProvider):
	id = ID
	name = NAME
	description = DESCRIPTION

	CATALOG_MAX_AGE = 300  # secondi: evita di ri-scaricare la homepage ad ogni click
	...
	# --- Le due funzioni sotto fanno rete vera (fetch della homepage): la UI
